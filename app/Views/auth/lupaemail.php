                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="headerText" style="font-size: 0px; padding: 10px 0  !important; word-break: break-word; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" align="center">
                                                <div style="font-family: Helvetica Neue, Helvetica, Arial; font-size: 36px !important; font-weight: 500; line-height: 45px !important; text-align: center; color: #000000;">Reset Password</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="subheaderText" style="font-size: 0px; padding: 10px 0  !important; word-break: break-word; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" align="center">
                                                <div style="font-family: Helvetica Neue, Helvetica, Arial; font-size: 18px !important; font-weight: 400; line-height: 24px !important; text-align: center; color: #8f99a7;">Seseorang meminta pengaturan ulang password <?= $_SERVER['HTTP_HOST'] ?> pada alamat email ini.</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="subheaderText" style="font-size: 0px; padding: 10px 0  !important; word-break: break-word; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" align="center">
                                                <div style="font-family: Helvetica Neue, Helvetica, Arial; font-size: 24px !important; font-weight: 400; line-height: 24px !important; text-align: center; color: #8f99a7;">Kode anda : <?= $hash ?>.</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="subheaderText" style="font-size: 0px; padding: 10px 0  !important; word-break: break-word; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" align="center">
                                                <div style="font-family: Helvetica Neue, Helvetica, Arial; font-size: 18px !important; font-weight: 400; line-height: 24px !important; text-align: center; color: #8f99a7;">Jika Anda tidak meminta penyetelan ulang sandi, Anda dapat mengabaikan email ini.</div>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="border: none; border-radius: 50px; cursor: auto; mso-padding-alt: 10px 25px; background: #007bff; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 15px 75px 15px 75px  !important;" align="center" bgcolor="#007bff" role="presentation" valign="middle">
                                                                <a style="display: inline-block; background: #007bff; color: inherit; font-family: Helvetica Neue, Helvetica, Arial; font-size: 18px; font-weight: 500; line-height: 120%; margin: 0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 50px;" href="<?= base_url('reset-password') . '?token=' . $hash ?>" target="_blank"> Reset Password</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
